				...
				<div class="row align-items-center">
					...
					<div class="col-sm-4">
						<div class="mt-4 mt-sm-0">
							<img src="/adminAssets/images/widget-img.png" class="img-fluid" alt="widget-img">
						</div>
					</div>
				</div>
			</div> <!-- end card-body-->
				...
				<div class="table-responsive">
					<table class="table align-middle table-striped table-nowrap mb-0">
						...
						<tbody>
							<tr>
								<td>
									<img src="/adminAssets/images/users/avatar-2.jpg" alt="user-image"
							...
							<tr>
								<td>
									<img src="/adminAssets/images/users/avatar-3.jpg" alt="user-image"
										class="avatar-xs rounded-circle me-2">
									Mathias N. Klausen
								</td>
							...
							<tr>
								<td>
									<img src="/adminAssets/images/users/avatar-4.jpg" alt="user-image"
										class="avatar-xs rounded-circle me-2">
									Nikolaj S. Henriksen
								</td>
								<td><i class="mdi mdi-checkbox-blank-circle text-success"></i> Confirm
							...
							<tr>
								<td>
									<img src="/adminAssets/images/users/avatar-5.jpg" alt="user-image"
										class="avatar-xs rounded-circle me-2">
									Lasse C. Overgaard
								</td>
							...
							<tr>
								<td>
									<img src="/adminAssets/images/users/avatar-6.jpg" alt="user-image"
										class="avatar-xs rounded-circle me-2">
									Kasper S. Jessen
								</td>
								<td><i class="mdi mdi-checkbox-blank-circle text-success"></i> Confirm
					...
					<table class="table align-middle table-striped table-nowrap mb-0">
						...
						<tbody>
							<tr>
								<td>#12354781</td>
								<td>
									<img src="/adminAssets/images/products/img-1.png" alt="user-image" style="height: 32px;" class="rounded me-2">
							...
							<tr>
								<td>#52140300</td>
								<td>
									<img src="/adminAssets/images/products/img-2.png" alt="user-image" style="height: 32px;" class="rounded me-2">
							...
							<tr>
								<td>#96254137</td>
								<td>
									<img src="/adminAssets/images/products/img-3.png" alt="user-image" style="height: 32px;" class="rounded me-2">
							...
							<tr>
								<td>#12365474</td>
								<td>
									<img src="/adminAssets/images/products/img-4.png" alt="user-image" style="height: 32px;" class="rounded me-2">
							...
							<tr>
								<td>#85214796</td>
								<td>
									<img src="/adminAssets/images/products/img-5.png" alt="user-image" style="height: 32px;" class="rounded me-2">
									BeoPlay Speaker
								</td>
					...
					<table class="table table-hover table-borderless align-middle table-centered table-nowrap mb-0">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<img src="/adminAssets/images/users/avatar-1.jpg" alt="user" class="rounded-circle h-auto avatar-xs me-2">
							...
							<tr>
								...
								<td>
									<img src="/adminAssets/images/users/avatar-2.jpg" alt="user" class="rounded-circle h-auto avatar-xs me-2">
							...
							<tr>
								...
								<td>
									<img src="/adminAssets/images/users/avatar-3.jpg" alt="user" class="rounded-circle h-auto avatar-xs me-2">
							...
							<tr>
								...
								<td>
									<img src="/adminAssets/images/users/avatar-4.jpg" alt="user" class="rounded-circle h-auto avatar-xs me-2">
							...
							<tr>
								...
								<td>
									<img src="/adminAssets/images/users/avatar-5.jpg" alt="user" class="rounded-circle h-auto avatar-xs me-2">
